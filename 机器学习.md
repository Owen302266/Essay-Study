...
判别规则：$p\left(\mathcal{C}_{1} \mid x\right)=p(t=1 \mid x) \underset{\mathcal{C}_{0}}{\underset{\mathcal{C}_{1}}{\gtrless}} \frac{1}{2}$或者$\tilde{w}^{T} \phi(x) \underset{\mathcal{C}_{0}}{\stackrel{\mathcal{C}_{1}}{\gtrless}} 0$
